...
class Institution {
  Institution({this.id, required this.name, required this.commercialRegistration, required this.taxNumber, required this.address, required this.phone, required this.email, this.logoPath, this.visaFee = 0, this.tabbyFee = 0, this.tamaraFee = 0});
...
class AppUser {
  AppUser({this.id, required this.institutionId, required this.name, required this.phone, required this.role, this.photoPath, this.workPlan = WorkPlan.commission, this.commissionRate = .5, this.salary = 0});
...
class Supplier { Supplier({this.id, required this.institutionId, required this.name, required this.phone}); final int? id, institutionId; final String name, phone; Map<String,Object?> toMap()=>{'id':id,'institution_id':institutionId,'name':name,'phone':phone}; factory Supplier.fromMap(Map<String,Object?> m)=>Supplier(id:m['id'] as int,institutionId:m['institution_id'] as int,name:m['name'] as String,phone:m['phone'] as String); }

class InventoryItem {
  InventoryItem({this.id, required this.institutionId, required this.supplierId, required this.name, required this.color, required this.length, this.width = 4, required this.supplierPrice, required this.wholesalePrice, this.imagePath, this.lowStockAt = 10, required this.createdAt});
...
class Sale {
  Sale({this.id, required this.institutionId, required this.inventoryId, required this.sellerId, this.driverId, required this.customerName, required this.length, required this.width, required this.salePrice, required this.installation, required this.glueGallons, required this.glueCost, required this.ironPieces, required this.ironCost, required this.driverFee, required this.customerPayment, required this.driverPayment, required this.paymentFee, required this.createdAt});
