...
class _OperatingReportsPageState extends State<OperatingReportsPage> {
  ...
  @override Widget build(BuildContext context)=>FutureBuilder<(OperatingSummary,List<OperatingSaleRecord>,List<Map<String,dynamic>>,List<PersonOption>,List<InstitutionTrip>)>(future:data,builder:(context,s){
