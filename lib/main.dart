...
DropdownButtonFormField<String> select(String value,String label,List<String> items,ValueChanged<String?> change)=>DropdownButtonFormField(initialValue:value,decoration:InputDecoration(labelText:label),items:items.map((x)=>DropdownMenuItem(value:x,child:Text(x))).toList(),onChanged:change);
